...
class SMSController extends Controller
{
    ...
    public function showPhoneGroupForm(){
        ...
        return view('customer.phone-groups',[
    ...
    public function showTopUpTransactions(){
        return view('customer.top-up-transactions');
    }
    ...
    public function showComposeMessageForm(){
        ...
        //}else{
            return view('customer.compose-sms',[
    ...
    public function showScheduleSmsForm(){
        return view('customer.schedule-sms');
    }

    public function showApiInterface(){
        return view('customer.api-settings');
    }
    ...
    public function showSenderIdForm(){
        return view('customer.create-sender');
    }
    ...
    public function showRegisteredSenderIds(){
        return view('customer.all-sender-ids');
    }

    public function batchReport(){
        return view('customer.batch-report');
    }
}
